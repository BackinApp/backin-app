...
class Apps(models.Model):
    ...
    technology = models.CharField(choices=TECH_CHOICES, max_length=255, blank=True, null=True, default='-')
    tool = models.CharField(choices=TOOLS_CHOICES, max_length=255, blank=True, null=True, default='-')
    ...
    product = models.CharField(choices=PRODUCT_CHOICES, max_length=255, blank=True, default='-')
    output = models.CharField(choices=OUTPUT_CHOICES, max_length=255, blank=True, null=True, default='-')
